...
2. Clone your fork: `git clone https://github.com/helix-tcp/helix.git`
3. Navigate to the project directory: `cd helix`
...
If you have any questions, please [open an issue](https://github.com/helix-tcp/helix/issues/new) for discussion.
